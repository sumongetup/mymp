      ...
      <div className="pt-8 pb-14 flex flex-col gap-6 max-w-[760px]">
        ...
        <Card className="p-6 flex flex-col gap-3">
          ...
          <ul className="flex flex-col gap-2.5 text-[15.5px] leading-relaxed text-inksoft list-disc ps-5">
            ...
            <li>কোনো রাজনৈতিক দল বা সংস্থার পক্ষে বা বিপক্ষে অবস্থান নিই না। এটি একটি স্বাধীন উদ্যোগ, কোনো সরকারি সাইট নয়; বাংলাদেশ সরকার, জাতীয় সংসদ বা নির্বাচন কমিশনের সঙ্গে সম্পর্কিত নয়, আর কোনো দল বা সংসদ সদস্যের সঙ্গেও সম্পর্ক নেই।</li>
          </ul>
        </Card>
